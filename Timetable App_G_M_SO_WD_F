...
with tab1:
    ...
    # EXCEL DOWNLOAD
    master_excel = generate_excel(display_df, "IIM Ranchi - Master Timetable (Starts June 1, 2026)")
    st.download_button(
        label="📥 Download Master Timetable (Excel format)",
        data=master_excel,
        file_name="IIM_Ranchi_Master_Timetable.xlsx",
